...
<form:form method="post"
          action="/shopon/signUp" modelAttribute="user" class="form-inline justify-content-center">
          ...
          <div id="container">
		   ...
		   <fieldset >
		   <form:input type="text" class="form-control centre-bottom" placeholder="name"
		   path="name" disabled="disabled" />
		   </fieldset>
		   <fieldset >
		   <input class="btn btn-primary" value="Sign Up" type="submit">
		   <!-- <a href="/Spring4MVCHelloWorldDemo/logOut" class="btn btn-primary">Logout</a> -->
		   </fieldset>
